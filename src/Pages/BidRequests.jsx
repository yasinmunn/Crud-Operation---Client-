...
const BidRequests = () => {
    ...
    const handleStatus = async (id, prevStatus, status) => {
        if (prevStatus === status) return toast.error('Job In Progress');
                                            ...
                                            <tr key={bid._id}>
                                                ...
                                                <td className='px-4 py-4 text-sm whitespace-nowrap'>
                                                    <div className='flex items-center gap-x-2'>
                                                        <p className={`px-3 py-1  ${bid.category === 'Web Development' && 'rounded-full text-blue-500 bg-blue-100/60 text-xs'} ${bid.category === 'Graphics Design' && 'rounded-full text-emerald-500 bg-emerald-100/60 text-xs'} ${bid.category === 'Digital Marketing' && 'rounded-full text-pink-500 bg-pink-100/60 text-xs'} `}
                                                        >
                                                            {bid.category}
                                                        </p>
                                                    </div>
