                        ...
                        <div className='overflow-hidden border border-gray-200  md:rounded-lg'>
                            <table className='min-w-full divide-y divide-gray-200'>
                                ...
                                <tbody className='bg-white divide-y divide-gray-200 '>
                                    {jobs.map(job => <tr>
                                        <td key={job._Id} className='px-4 py-4 text-sm text-gray-500  whitespace-nowrap'>
                                            {job.job_title}
                                        </td>
                                        ...
                                        <td className='px-4 py-4 text-sm whitespace-nowrap'>
                                            <div className='flex items-center gap-x-2'>
                                                <p
                                                    className={`
                                                    px-3 py-1 
                                                    ${job.category === 'Web Development' && 'rounded-full text-blue-500 bg-blue-100/60 text-xs'
                                                        } ${job.category === 'Graphics Design' && 'rounded-full text-emerald-500 bg-emerald-100/60 text-xs'
                                                        } ${job.category === 'Digital Marketing' && 'rounded-full text-pink-500 bg-pink-100/60 text-xs'
                                                        }
                                                `}
                                                >
                                                    {job.category}
